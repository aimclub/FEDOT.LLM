#!/usr/bin/env python3
"""
MLZero Covertype Competition - Forest Cover Type Prediction Script using AutoGluon
This script predicts forest cover types from cartographic variables using AutoGluon's TabularPredictor
Multiclass classification task with F1 evaluation metric
"""
...
# Configuration
DATA_DIR = "mlzero/covertype/competition"
...
print("=" * 80)
print("MLZero Covertype Competition - Forest Cover Type Prediction using AutoGluon")
print("=" * 80)
...
print(f"Features include: Elevation, Aspect, Slope, Distance features, Wilderness Areas, Soil Types")
...
predictor = TabularPredictor(
    label=TARGET_COLUMN,
    eval_metric='f1_weighted',  # F1 weighted is the evaluation metric for multiclass
...
print(f"Validation performance (F1): {val_performance}")
