#!/usr/bin/env python3
"""
MLZero Abalone Competition - Age Prediction Script using AutoGluon
This script predicts the number of rings in abalone shells (age proxy) using AutoGluon's TabularPredictor
...
# Configuration
DATA_DIR = "mlzero/abalone/competition"
...
print("=" * 80)
print("MLZero Abalone Competition - Age Prediction using AutoGluon")
print("=" * 80)
...
print(f"Mean: {submission['rings'].mean():.2f}")
print(f"Min: {submission['rings'].min():.2f}")
print(f"Max: {submission['rings'].max():.2f}")
print(f"Std: {submission['rings'].std():.2f}")
