#!/usr/bin/env python3
"""
Kaggle Playground Series S4E2 - Obesity Risk Prediction Script using AutoGluon
This script predicts obesity risk categories using AutoGluon's TabularPredictor
"""
...
# Configuration
DATA_DIR = "autokaggle/playground-series-s4e2"
...
print("=" * 80)
print("Playground Series S4E2 - Obesity Risk Prediction using AutoGluon")
print("=" * 80)
