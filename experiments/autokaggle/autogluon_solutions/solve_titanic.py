#!/usr/bin/env python3
"""
Kaggle Titanic - Machine Learning from Disaster Script using AutoGluon
This script predicts survival on the Titanic using AutoGluon's TabularPredictor
"""
...
print("=" * 80)
print("Titanic - Machine Learning from Disaster using AutoGluon")
print("=" * 80)
...
print(f"Survival rate: {train_data[TARGET_COLUMN].mean()*100:.2f}%")

# Identify columns to drop (PassengerId, Name, and Ticket are not useful for prediction)
...
print(f"Predicted survival rate: {submission['Survived'].mean()*100:.2f}%")
