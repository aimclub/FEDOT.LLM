#!/usr/bin/env python3
"""
Kaggle Ghouls, Goblins, and Ghosts Classification Script using AutoGluon
This script classifies creatures into Ghost, Goblin, or Ghoul using AutoGluon's TabularPredictor
"""
...
# Configuration
DATA_DIR = "autokaggle/ghouls-goblins-and-ghosts-boo"
...
print("=" * 80)
print("Ghouls, Goblins, and Ghosts Classification using AutoGluon")
print("=" * 80)
...
predictor = TabularPredictor(
    label=TARGET_COLUMN,
    eval_metric='accuracy',  # Classification accuracy is the evaluation metric
