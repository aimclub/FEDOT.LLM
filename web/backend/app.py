...
from web.common.types import (BaseResponse, PipeLineResponse,
...
class FedotAIBackend:
    ...
    async def ask(self, request: RequestFedotLLM) -> AsyncIterator[BaseResponse]:
        ...
        self.fedot_ai.handlers = [message_handler, self.actions.handler]
        
        PipeLineResponse().register_hooks(response=response, actions=self.actions)
