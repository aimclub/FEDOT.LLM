...
from fedot_llm.ai.chains.base import BaseRunnableChain, ChainPassthrough, ChainAddStrKey, ChainMapToClassName
...
class DefineMetaInfo(BaseRunnableChain):
    ...
    def __init__(self, model: BaseChatModel, dataset: Dataset):
        self.chain = (
            ...
            | ChainAddStrKey("dataset_detailed_description", dataset.detailed_description)
