...
class OpenaiEmbeddings:
    ...
    def __init__(self, api_key: Optional[SecretStr] = None, base_url: Optional[str] = None, model: Optional[str] = None):
        api_key = SecretStr(api_key or get_settings()["OPENAI_TOKEN"])
