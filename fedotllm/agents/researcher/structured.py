...
class Citation(BaseModel):
    ...
    number: int = Field(..., description="The number of the citation.")
...
class GenerateWithCitations(BaseModel):
    ...
    answer: str = Field(..., description="A plain text answer, formatted as Markdown.")
...
class GradeHallucination(BaseModel):
    ...
    score: BoolAnswer = Field(description="Answer is grounded in facts, 'yes' or 'no'.")
