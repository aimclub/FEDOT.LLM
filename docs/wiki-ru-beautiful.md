...
- [🐳 Настройка Docker](#-настройка-docker)
  - [📋 Предварительные требования Docker](#-предварительные-требования-docker)
  - [🚀 Быстрый старт с Docker](#-быстрый-старт-с-docker)
  - [🏗️ Архитектура Docker](#%EF%B8%8F-архитектура-docker)
  - [🛠️ Справочник команд Makefile](#%EF%B8%8F-справочник-команд-makefile)
